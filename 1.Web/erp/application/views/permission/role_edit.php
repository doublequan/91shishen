...
<div class="row">
    <div class="col-md-12 form_body">
        ...
        <form action="<?php echo site_url('permission/role/doEdit'); ?>" id="permission_role_form" method="post">
                        ...
                        <div class="col-md-11">
                            ...
                            <div class="panel panel-default panel-condensed">
                                <div class="panel-heading">
                                    ...
                                    <b style="padding-left:10px;"><input type="checkbox" class="checkAll" value="<?php echo $group_id; ?>"> 全选</b>
                                </div>
                                <div class="panel-body">
                                    <?php foreach ($permission as $sin_permission) { ?>
                                    <label class="col-md-2" style="font-weight:normal">
                                        <input type="checkbox" name="permission_ids[]" class="permission_id group_<?php echo $group_id; ?>" value="<?php echo $sin_permission['id']; ?>"<?php echo array_key_exists($sin_permission['id'], $curr_permissions) ? ' checked' : ''; ?>>&nbsp;
