    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <form class="form-inline" action="<?php echo site_url('stat/pay/yeepay'); ?>" method="get" id="search_form">
            ...
            <table class="table table-bordered table-hover text-center">
                <thead>
                    <tr>
                        ...
                        <th width="12%">支付金额</th>
                        <th width="12%">支付状态</th>
                        <th width="12%">易宝交易流水号</th>
                        <th width="12%">易宝渠道类型</th>
                        <th width="20%">易宝交易类型</th>
                        <th width="20%">交易时间</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['trade_no'] ? '<font color="green">已支付</font>' : '<font color="red">未支付</font>'; ?></td>
                        <td><?php echo $row['trade_no']; ?></td>
                        <td><?php echo isset($channelMap[$row['channel']]) ? $channelMap[$row['channel']] : ''; ?></td>
                        <td><?php echo isset($typeMap[$row['trade_type']]) ? $typeMap[$row['trade_type']] : ''; ?></td>
                        <td><?php echo $row['trade_time'] ? date('Y-m-d H:i:s',$row['trade_time']) : ''; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
