...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('products/spec/doEdit'); ?>" method="post" name="spec_form" id="spec_form">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 form_input">
                            <input type="text" name="unit" class="form-control" value="<?php echo $single['unit']; ?>" id="unit">
                        </div>
                    </div>
