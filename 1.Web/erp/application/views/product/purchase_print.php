...
<head>
    <meta charset="UTF-8">
    <title>惠生活采购单：<?php echo $single['id']; ?></title>
    ...
    body{
        font:18px "宋体", Helvetica, Arial, sans-serif;
    }
    </style>
</head>
<body>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="30%"><?php echo empty($single['create_time'])?'':$single['create_time']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="30%"><?php echo $store_prov.' '.$store_city; ?></td>
                        <th width="20%" class="text-right">入库门店</th>
                        <td width="30%"><?php echo $store_info['name']; ?></td>
                    </tr>
                    <tr>
