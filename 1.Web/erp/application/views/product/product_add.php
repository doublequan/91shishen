...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="<?php echo site_url('products/product/doAdd'); ?>" method="post" id="product_form" class="form-horizontal">
            <div class="row">
                <div class="col-sm-12">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <label class="radio-inline">
                            <input type="radio" name="type" value="0" checked> 普通商品
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="type" value="1"> 预售商品
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="type" value="2"> 团购商品
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="type" value="3"> 积分商品
                        </label>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="delivery" class="form-control" id="delivery">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="product_pin" class="form-control" id="product_pin">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-6 form_input">
                        ...
                        <input type="hidden" name="good_info" id="good_info">
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="good_num" id="good_num" class="form-control" value="">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="price_market" class="form-control" id="price_market">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="integral" class="form-control" id="integral" value="0">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="spec_packing" class="form-control" id="spec_packing">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-3 form_input">
                        <input type="text" name="loss_set" class="form-control text-center" id="loss_set" value="0">
                    </div>
                    <label class="col-sm-3 control-label form_label">
                        统计损耗率(%)
                    </label>
                    <div class="col-sm-3 form_input">
                        <input type="text" name="loss_stat" class="form-control text-center" value="0" disabled>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="product_place" class="form-control" id="product_place">
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="product_level" class="form-control" id="product_level">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="alert alert-success cate_img_alert" id="thumb_alert" style="display:none;">上传成功</div>
                    </div>
                </div>
                <div class="form-group col-sm-6">
