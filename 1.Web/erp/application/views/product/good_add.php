...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('products/good/doAdd'); ?>" method="post" id="good_form">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 form_input">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="method" class="method" value="<?php echo $k; ?>"<?php echo $k==1 ? ' checked' : ''; ?>> <?php echo $v; ?>
                            </label>
                            <?php } ?>
                            <?php } ?>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 form_input units" id="units_<?php echo $method; ?>"<?php echo $method==1 ? '' : ' style="display:none;"'; ?>>
                            <?php foreach( $units as $k=>$v ) { ?>
                            <label class="radio-inline">
                                <input type="radio" name="unit" class="unit" value="<?php echo $v; ?>"<?php echo $method==1 && $k==0 ? ' checked' : ''; ?>> <?php echo $v; ?>
                            </label>
                            <?php } ?>
                        </div>
                        <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 form_input">
                            <input type="text" name="amount" class="form-control" id="amount" value="1">
                        </div>
                    </div>
                    <div class="form-group">
...
$(document).ready(function($) {
    ...
    $('.method').change(function(){
        ...
        $('#units_'+method+' input').eq(0).attr('checked','checked');
        $('.units').hide();
        $('#units_'+method).show();
    });
