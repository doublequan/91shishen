...
<body>
    ...
    foreach ($label_list as $label) {
        if (intval($label['product_pin']) < 10000) {
        $idx++;
    ?>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left;" >
                            <img src="/static/png/<?php echo $label['product_pin'];?>.png" style="width: 200px;height: 60px;border: 0px;padding-left: 10px;">
                        </td>
