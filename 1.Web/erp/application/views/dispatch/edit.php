...
<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            ...
            <li><a href="">调度管理</a></li>
            <li><a href="<?php echo site_url('dispatch/my'); ?>">我的调度单</a></li>
...
<div class="row">
    <div class="col-md-12 form_body">
        ...
        <form action="<?php echo site_url('dispatch/my/doEdit'); ?>" method="post" id="dispatch_form">
                                ...
                                <?php foreach ($dispatch_goods as $value) { ?>
                                    <tr good_id="<?php echo $value['id']; ?>">
                                        ...
                                        <td style="padding:3px;">
                                            <input type="text" class="form-control input-sm goods_amount" style="width:60px;text-align:center;" name="goods_amount[]" 
                            ...
                            <table class="table table-striped table-hover table-center" id="products_table">
                                ...
                                <?php foreach ($dispatch_products as $value) { ?>
                                    <tr product_id="<?php echo $value['id']; ?>">
                                        ...
                                        <td style="padding:3px;">
                                            <input type="text" class="form-control input-sm products_amount" style="width:60px;text-align:center;" name="products_amount[]" 
...
<iframe src="<?php echo site_url('products/good/muti_select_dialog'); ?>" id="add_good_page" class="iframe_dialog" style="height:580px;"></iframe>
...
function generateProductTr(product_info, category_name){
    ...
    tr_str.push('<td style="padding:3px;"><input type="text" class="form-control input-sm products_amount" style="width:60px;text-align:center;" name="products_amount[]"></td>');
            ...
            $.post($form.attr('action'), $form.serialize(), function(rst_json) {
                if(rst_json.err_no != 0){
                    ...
                    window.setTimeout(function(){
                        window.location.href = "<?php echo site_url('dispatch/my'); ?>";
                    },2000);
                }
            }, 'json');
        });
