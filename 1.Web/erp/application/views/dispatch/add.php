...
<div class="row">
    <div class="col-md-12 form_body">
        ...
        <form action="<?php echo site_url('dispatch/my/doAdd'); ?>" method="post" id="dispatch_form">
...
function generateProductTr(product_info, category_name){
    ...
    tr_str.push('<td><input type="text" class="form-control input-sm products_amount" style="width:60px;text-align:center;" name="products_amount[]"></td>');
