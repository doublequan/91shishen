...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('vip/category/doEdit'); ?>" id="category_form" method="post">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="alert alert-success cate_img_alert_sm" id="thumb_alert">已上传图片！</div>
                        </div>
                    </div>
