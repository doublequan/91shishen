...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="<?php echo site_url('vip/product/doAdd'); ?>" method="post" id="product_form" class="form-horizontal">
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        ...
                        <!-- <p class="form-control-static form-help-p">商品名称长度不能超过200字符</p> -->
                    </div>
                </div>
                <div class="form-group col-sm-6">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        ...
                        <?php foreach ($specs as $spec) { ?>
                            <option value="<?php echo $spec['id']; ?>"><?php echo trim($spec['name']); ?></option>
                        <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        ...
                        <?php foreach ($brands as $brand) { ?>
                            <option value="<?php echo $brand['id']; ?>"><?php echo trim($brand['name']); ?></option>
                        <?php } ?>
                        </select>
                    </div>
                </div>
