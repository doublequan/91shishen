    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <form class="form-inline" action="<?php echo site_url('vip/price'); ?>" method="get" id="search_form">
                    <input type="hidden" name="product_id" id="product_id" value="<?php echo $params['product_id']; ?>">
                    <div class="form-group">
                        <p class="form-control-static input-sm">
                            商品名称：
                            <?php echo empty($single['title'])?'无商品信息，请查询其他商品！':'<span class="font-bold">'.$single['title'].'</span>'; ?>
                        </p>
                    </div>
                    ...
                    <a class="btn btn-primary btn-sm" id="add_form_btn" href="#add_form_page" kesrc="#add_form_page">修改商品价格</a>
                </form>
            </div>
            <?php 
                if(!empty($results)){ 
...
<div id="add_form_page" style="height:300px;width:600px;">
    ...
    <form action="<?php echo site_url('vip/price/doAdd'); ?>" method="post" id="price_form" class="form-horizontal">
...
$(document).ready(function() {
    ...
    var options = {
        ...
        title: {
            text: "商品名称：<b><?php echo $single['title']; ?></b>"
        },
        xAxis: {
            type: 'datetime',
