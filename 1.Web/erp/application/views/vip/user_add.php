...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('vip/user/doAdd'); ?>" method="post" id="user_form">
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-9 form_input">
                                <input type="text" name="position" class="form-control" value="" id="position">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="" class="col-sm-3 control-label form_label">
...
$(document).ready(function($) {
    ...
    $('#user_form')
        .bootstrapValidator(validate_rules.vip_user_add)
