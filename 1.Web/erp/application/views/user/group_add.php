...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('user/group/doAdd'); ?>" method="post" id="group_form">
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-9 form_input">
                                <input type="text" name="min" class="form-control" value="" id="min">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-9 form_input">
                                <input type="text" name="max" class="form-control" value="" id="max">
