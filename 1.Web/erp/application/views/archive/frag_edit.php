...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('archive/frag/doEditFrag'); ?>" id="form" method="post">
                ...
                <div class="form-horizontal">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9 form_input">
                                ...
                                <?php foreach ($frag_types as $k=>$v) { ?>
                                    <option value="<?php echo $k; ?>"<?php echo $single['type']==$k ? ' selected' : ''; ?>><?php echo trim($v); ?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9 form_input">
                                <input type="text" name="url" class="form-control" id="url" value="<?php echo $single['url']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="img_1">
                            ...
                            <div class="col-sm-9 form_input">
                                <input type="text" name="img_url" class="form-control" id="img_url" value="<?php echo $single['img']; ?>">
                            </div>
                        </div>
                        <div class="form-group col-sm-6" id="img_0" style="display:none;">
                            ...
                            <div class="col-sm-5 form_input" id="thumb_line">
                                <input type="hidden" name="img_upload" id="thumb_hide" value="<?php echo $single['img']; ?>">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9 form_input">
                                <textarea name="des" rows="5" class="form-control"><?php echo $single['des']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="name" class="col-sm-3 control-label form_label">
                            ...
                            <div class="col-sm-9 form_input">
                                <textarea name="extend" rows="5" class="form-control"><?php echo $single['extend']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9 form_input">
                                <input type="text" name="sort" class="form-control" value="<?php echo $single['sort']; ?>">
                            </div>
                        </div>
                    </div>
