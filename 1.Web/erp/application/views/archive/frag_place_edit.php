...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('archive/frag/doEditPlace'); ?>" id="form" method="post">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9 form_input">
                                ...
                                <?php foreach ($sites as $row) { ?>
                                    <option value="<?php echo $row['id']; ?>"<?php echo $single['site_id']==$row['id'] ? ' selected' : ''; ?>><?php echo trim($row['name']); ?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9 form_input">
                                ...
                                <?php foreach ($os_types as $k=>$v) { ?>
                                    <option value="<?php echo $k; ?>"<?php echo $single['os']==$k ? ' selected' : ''; ?>><?php echo trim($v); ?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-9 form_input">
                                <label class="radio-inline">
                                    <input type="radio" name="is_lock" value="1"<?php echo $single['is_lock']==1 ? ' checked' : ''; ?>> 锁定
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_lock" value="0"<?php echo $single['is_lock']==0 ? ' checked' : ''; ?>> 不锁定
                                </label>
                            </div>
                        </div>
                    </div>
