...
<div class="row">
    <div class="col-md-12"style="padding-right: 25px;">
        ...
        <form action="<?php echo site_url('archive/archive/doEdit'); ?>" method="post" id="archive_form" class="form-horizontal">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        ...
                        <?php foreach ($categorys as $k=>$row) { ?>
                            <option value="<?php echo $k; ?>"<?php echo $single['category_id']==$k ? ' selected' : ''; ?>><?php echo trim($row['name']); ?></option>
                        <?php } ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="sort" class="form-control" id="sort" value="<?php echo $single['sort']; ?>">
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <label class="radio-inline">
                            <input type="radio" name="template_id" value="1"<?php echo $single['template_id']!=2 ? ' checked' : ''; ?>> 带分类内容
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="template_id" value="2"<?php echo $single['template_id']==2 ? ' checked' : ''; ?>> 通栏内容
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="seo_title" class="form-control" value="<?php echo $single['seo_title']; ?>">
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-9 form_input">
                        <input type="text" name="seo_keywords" class="form-control" value="<?php echo $single['seo_keywords']; ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-11 form_input">
                        <textarea name="seo_description" rows="4" class="form-control"><?php echo $single['seo_description']; ?></textarea>
                    </div>
                </div>
            </div>
