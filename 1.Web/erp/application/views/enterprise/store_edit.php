...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 form_body">
            ...
            <form action="<?php echo site_url('enterprise/store/doEdit'); ?>" method="post" id="store_form">
                <div class="form-horizontal">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                ...
                                <?php foreach ($sites as $site) { ?>
                                    <option value="<?php echo $site['id']; ?>" company_id="<?php echo $site['company_id']; ?>" <?php echo $site['id']==@$single['site_id']?'selected':''; ?>><?php echo trim($site['name']); ?></option>
                                <?php } ?>
                                </select>
                            </div>
                            <input type="hidden" name="company_id" id="company_id" value="<?php echo @$single['company_id']; ?>">
                        </div>
                        <!-- <div class="form-group col-md-6">
                            <label for="" class="col-md-3 control-label form_label">
                                <span><font color="red">*</font></span>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-6 form_input">
                                <input type="text" name="employee_name" class="form-control" id="employee_name" readOnly value="<?php echo $manager['username']; ?>">
                                <input type="hidden" name="manager" class="form-control" id="employee_id" value="<?php echo $single['manager']; ?>">
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                ...
                                <?php foreach ($district_list as $district) { ?>
                                    <option value="<?php echo $district['id']; ?>" <?php echo $district['id']==$single['district']?'selected':''; ?>><?php echo $district['name']; ?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                <input type="text" name="loc" class="form-control" id="loc" value="<?php echo @$single['loc']; ?>">
                                格式为“115.214,39.4122”，前面经度，后面纬度
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                <input type="text" name="open_time" class="form-control" id="open_time" value="<?php echo empty($single['loc'])?'09:00 - 21:00':$single['loc']; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                <label class="radio-inline">
                                    <input type="radio" name="is_process" class="is_process" value="1" <?php echo ($single['is_process']==1)?'checked':''; ?>> 是
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_process" class="is_process" value="0" <?php echo ($single['is_process']==0)?'checked':''; ?>> 否
                                </label>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                <label class="radio-inline">
                                    <input type="radio" name="is_sell" class="is_sell" value="1" <?php echo ($single['is_sell']==1)?'checked':''; ?>> 是
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_sell" class="is_sell" value="0" <?php echo ($single['is_sell']==0)?'checked':''; ?>> 否
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                <label class="radio-inline">
                                    <input type="radio" name="is_storage" class="is_storage" value="1" <?php echo ($single['is_storage']==1)?'checked':''; ?>> 是
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_storage" class="is_storage" value="0" <?php echo ($single['is_storage']==0)?'checked':''; ?>> 否
                                </label>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                <label class="radio-inline">
                                    <input type="radio" name="is_pickup" class="is_pickup" value="1" <?php echo ($single['is_pickup']==1)?'checked':''; ?>> 是
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_pickup" class="is_pickup" value="0" <?php echo ($single['is_pickup']==0)?'checked':''; ?>> 否
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9 form_input">
                                <label class="radio-inline">
                                    <input type="radio" name="is_delivery" class="is_delivery" value="1" <?php echo ($single['is_delivery']==1)?'checked':''; ?>> 是
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="is_delivery" class="is_delivery" value="0" <?php echo ($single['is_delivery']==0)?'checked':''; ?>> 否
                                </label>
                            </div>
                        </div>
                    </div>
