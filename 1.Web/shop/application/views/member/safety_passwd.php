...
<div class="breadcrumb area">
	<a href="<?=base_url()?>">首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?=base_url('member/home/index')?>">个人中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?=base_url('member/safety/index')?>">账号安全</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;修改密码
</div>
...
function updPass(){
	...
	if(old_pass == password){
		layer.tips("提示：新密码不能与旧密码相同！", $("#password"), {time:2});
		$("#password").focus();
		return false;
	}
	...
	layer.load("提交中...");
	$.ajax({
		url: "<?=base_url('member/safety/ajax_passwd')?>",
		type: "post",
		dataType: "json",
