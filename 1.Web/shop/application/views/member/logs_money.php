...
<title>资金记录 - 个人中心 - <?=$siteName?></title>
...
<div class="breadcrumb area">
	<a href="<?=base_url()?>">首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?=base_url('member/home/index')?>">个人中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;资金记录
</div>
	...
	<div class="mylist">
		<div class="favorite">
			...
			<div class="flist mt10">
				<table>
					<tr><th>ID</th><th>变动金额</th><th>剩余金额</th><th>备注信息</th><th>创建时间</th></tr>
