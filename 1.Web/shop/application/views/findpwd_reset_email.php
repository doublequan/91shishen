...
<div class="reg area">
	<div class="middle">
		...
		<dl class="clearfix" >
			<dt><em>*</em>邮箱账号：</dt>
			<dd>
				<input type="text" id="email" value="<?=$email?>" placeholder="请输入您绑定的邮箱账号" />
			</dd>
		</dl>
		<dl class="clearfix" >
			<dt><em>*</em>验证码：</dt>
			<dd>
				<input type="text" id="verify" maxlength="10" placeholder="请输入验证码" />
			</dd>
		</dl>
		<dl class="clearfix" >
			<dt><em>*</em>设置密码：</dt>
...
function doSubmit(){
	...
	$.ajax({
		...
		type: "post",
		dataType: "json",
		data: {"username":username, "email":email, "verify":verify, "password":password},
