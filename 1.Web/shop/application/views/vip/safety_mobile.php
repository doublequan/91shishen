...
<div class="breadcrumb area">
	<a href="<?=base_url()?>">首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?=base_url('vip/home/index')?>">个人中心</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?=base_url('vip/safety/index')?>">账号安全</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;修改手机
</div>
<div class="Ucenter mt20 area">
	...
	<div class="mylist">
		<div class="password">
			...
			<div class="pass">
				<ul>
					<li><label>手机号：</label><input type="text" id="mobile" maxlength="11" /><span>请输入要验证的手机号码</span></li>
...
function getVerify(){
	...
	layer.load("发送中...");
	$.ajax({
		url: "<?=base_url('vip/safety/ajax_mobile')?>",
		type: "post",
		dataType: "json",
		data: {"mobile":mobile},
...
function verifyMobile(){
	...
	layer.load("提交中...");
	$.ajax({
		url: "<?=base_url('vip/safety/ajax_verify')?>",
		type: "post",
		dataType: "json",
